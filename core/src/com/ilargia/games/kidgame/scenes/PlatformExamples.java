...
//                        , new Vector2(0.7f,0f),new Vector2(0, 1),new Vector2(0, 0));
        entitas.scene.createEntity()
                .addParallaxLayer(new TextureRegion(assetsManager.getTexture("imagenes/fondos/nubes.png"))
...
//                .addCDirectionalLight(84, Color.SKY, 270);
        ...
        box1.addTags("Box1").setInteractive(true).getRigidBody().body.setTransform(20,7,0);

        GameEntity box2 = sceneManager.createEntity("Box");
        box2.addTags("Box2").setInteractive(true).getRigidBody().body.setTransform(10,7,0);

        GameEntity box3 = sceneManager.createEntity("Box");
        box3.addTags("Box3").setInteractive(true).getRigidBody().body.setTransform(15,9,0);

        entitas.actuator.setDragActuator(ground.getCreationIndex(), false, 500);
